...
public struct SectionSet<Item: Equatable, Header: Equatable, Footer: Equatable>: ExpressibleByArrayLiteral {
    public typealias Iterator = SectionSetIterator<Item, Header, Footer>
...
extension SectionSet: MutableCollection {
    ...
    public func makeIterator() -> SectionSetIterator<Item, Header, Footer> {
        .init(sectionSet: self)
    }
}
